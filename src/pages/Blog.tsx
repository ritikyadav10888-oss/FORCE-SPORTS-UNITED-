    ...
    <section className="section-padding">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mt-14">
          ...
          <Link to="/contact" className="inline-flex items-center gap-2 text-primary font-heading text-sm tracking-wider uppercase hover:opacity-80 transition-opacity">
