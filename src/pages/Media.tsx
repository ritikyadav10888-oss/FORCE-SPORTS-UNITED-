...
const services = [
  {
    ...
    desc: "Professional multi-camera live streaming on YouTube with real-time graphics, scorecard overlays, and audience engagement.",
  },
  {
    icon: Mic,
    title: "Professional Commentary",
    desc: "Experienced commentators who bring energy, insights, and entertainment to every match broadcast.",
  },
  {
    icon: Video,
    title: "Match Highlights",
    desc: "Quick-turnaround highlight packages — best moments, key plays, and dramatic finishes edited professionally.",
  },
  {
    icon: Camera,
    title: "Event Photography",
    desc: "Professional on-ground photography capturing action shots, team portraits, and candid moments.",
  },
  {
    icon: Film,
    title: "Reels & Short Content",
    desc: "Social-media-ready vertical content — reels, shorts, and stories designed for maximum engagement.",
  },
  {
    icon: Share2,
    title: "Social Media Coverage",
    desc: "Real-time posting, stories, and live updates across platforms to amplify your event's reach.",
  },
];
  ...
  <Layout>
    ...
    <section className="section-padding">
      <div className="max-w-6xl mx-auto grid md:grid-cols-2 lg:grid-cols-3 gap-6">
        {services.map((s, i) => (
          <div
            key={s.title}
            className="bg-card border border-border rounded-lg p-8 hover:border-primary transition-colors animate-fade-in-up"
      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12">
          <h2 className="font-heading text-3xl md:text-4xl font-bold mb-4 uppercase">
            <span className="text-gradient">Event Galleries</span>
          </h2>
          <p className="text-muted-foreground max-w-xl mx-auto">
            Browse and download high-quality images from our past tournaments and corporate events.
          </p>
        </div>
    ...
    <section className="bg-gradient-brand section-padding text-center">
      <div className="max-w-3xl mx-auto">
        ...
        <p className="text-primary-foreground/80 mb-8">Professional production that takes your event from local to legendary.</p>
