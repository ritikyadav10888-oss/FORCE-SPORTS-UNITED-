      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
        <div>
          ...
          <div className="flex gap-4 mt-8 text-muted-foreground">
            ...
            <a href="https://in.linkedin.com/company/force-sports-united" target="_blank" rel="noopener noreferrer" className="bg-[#1a1a1a] p-2.5 rounded-md hover:bg-primary/20 hover:text-primary transition-all duration-300" aria-label="LinkedIn"><Linkedin size={18} /></a>
