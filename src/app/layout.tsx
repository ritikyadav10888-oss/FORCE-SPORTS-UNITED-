...
const organizationJsonLd = {
  ...
  sameAs: [
    ...
    "https://in.linkedin.com/company/force-sports-united",
...
'https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);
})(window,document,'script','dataLayer','GTM-THD947J4');`,
          }}
        />
      ...
      <body className="antialiased min-h-screen bg-background text-foreground">
        <noscript>
          <iframe
            src="https://www.googletagmanager.com/ns.html?id=GTM-THD947J4"
            height="0"
            width="0"
